...
class TopicDetailResponse {
  ...
  String vTwttrshares = "";
  String vGplusshares = "";
  FormResponseTopic cPostRespond = FormResponseTopic.TEXT;
  String cPostComment = "";
  String nPostUrlflip = "";
  ...
  String nSubject = "";
  String respon = "";
  List<TopicReplyResponse>? respond = [];
  ...
  TopicDetailResponse(
      ...
      this.vTwttrshares = "",
      this.vGplusshares = "",
      cPostRespond = FormResponseTopic.TEXT,
      this.cPostComment = "",
      this.nPostUrlflip = "",
      this.iPostPlatform = "",
  ...
  TopicDetailResponse.fromJson(Map<String, dynamic> json) {
    iPost = json['i_post'];
    dPost = json['d_post'];
    ...
    cPostRespond = json['c_post_respond'] == "3"
        ? FormResponseTopic.IMAGE
        : json['c_post_respond'] == "4"
            ? FormResponseTopic.VIDEO
            : FormResponseTopic.TEXT;
    ...
    respon = json['respon'];
    if (json['respond'] != null) {
      respond = <TopicReplyResponse>[];
      json['respond'].forEach((v) {
        respond?.add(new TopicReplyResponse.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.respond != null) {
      data['respond'] = this.respond?.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
