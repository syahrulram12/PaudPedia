import 'package:paudpedia_kemendikbud/models/together_room/forumlist/forum_detail_reply_response.dart';

class ForumDetailResponse {
  String iPost = "";
  String dPost = "";
  String iSubject = "";
  String dPostPublish = "";
  ...
  String nUserPict = "";
  String nSubject = "";
  List<ForumDetailReplyResponse>? comment = [];
  ...
  ForumDetailResponse.fromJson(Map<String, dynamic> json) {
    iPost = json['i_post'];
    dPost = json['d_post'];
    ...
    if (json['comment'] != null) {
      comment = <ForumDetailReplyResponse>[];
      json['comment'].forEach((v) {
        comment?.add(new ForumDetailReplyResponse.fromJson(v));
      });
    } else {
      comment = [];
    }
